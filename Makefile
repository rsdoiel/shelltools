...
build: bin/csvcols bin/findfile bin/finddir bin/jsonquery bin/pathparts bin/mergepath bin/reldate bin/range bin/timefmt bin/urlparse
...
bin/jsonquery: shelltools.go cmds/jsonquery/jsonquery.go
...
dist/linux-amd64:
	...
	env CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o dist/linux-amd64/jsonquery cmds/jsonquery/jsonquery.go
...
dist/macosx-amd64:
	...
	env CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o dist/macosx-amd64/jsonquery cmds/jsonquery/jsonquery.go
...
dist/windows-amd64:
	...
	env CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o dist/windows-amd64/jsonquery.exe cmds/jsonquery/jsonquery.go
...
dist/raspbian-arm7:
	...
	env CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=7 go build -o dist/raspbian-arm7/jsonquery cmds/jsonquery/jsonquery.go
...
dist/raspbian-arm6:
	...
	env CGO_ENABLED=0 GOOS=linux GOARCH=arm GOARM=6 go build -o dist/raspbian-arm6/jsonquery cmds/jsonquery/jsonquery.go
